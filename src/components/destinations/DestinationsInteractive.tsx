  ...
  return (
    <div className="w-full min-w-0 overflow-x-hidden">
      ...
      <section
        ...
        className="relative z-20 mt-3 w-full min-w-0 max-w-[100vw] bg-gradient-to-b from-[#f8f4ee]/75 from-0% via-[#faf7f3]/45 via-45% to-transparent px-3 pb-6 pt-0 sm:mt-4 sm:px-4 sm:pb-8 lg:mt-5 lg:px-5"
      >
