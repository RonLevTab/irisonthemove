    ...
    <div className="w-full min-w-0">
      ...
      */}
      <section
        ...
        className="sticky top-[var(--nav-stack-height)] z-30 w-full min-w-0 max-w-[100vw] border-0 bg-[var(--color-background)] px-7 pt-5 pb-5 shadow-none sm:px-10 sm:pt-6 sm:pb-6 lg:px-16 lg:pt-6 lg:pb-6 xl:px-18"
      >
      ...
      <section
        ...
        className="mt-0 w-full min-w-0 max-w-[100vw] bg-gradient-to-b from-[#f8f4ee]/75 from-0% via-[#faf7f3]/45 via-45% to-transparent px-3 pb-6 pt-0 sm:px-4 sm:pb-8 lg:px-5"
      >
